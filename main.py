...
from app.scenes.history import run_story
...
def main():
    ...
    Fluxo:
        ...
        3. Executa a cena de história (run_story).
        4. Executa a cena de introdução (run_intro).
        5. Dependendo do resultado da introdução:
            - "sair": encerra o jogo.
            - "iniciar": fecha a janela atual e chama a função principal de `gameplay`.
        6. Fecha o pygame e encerra o programa em qualquer outro caso.
